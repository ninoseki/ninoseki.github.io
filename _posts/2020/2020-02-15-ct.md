---
title: Gleaning on Certificate Transparency (or how cretstream-server is improved)
---
...
CT is developed by Google to audit or monitor SSL certificates in real time and it is also for threat hunting. (e.g. phishing detection)
...
certsream-server doesn't take this behavior into account so it overlooks some entries.
